...
info.lhs_names  = {'tdi','pibperc','ginitot2','tpm'};  % primera variable no responde de forma contemp. / segunda responde contemp. a la primera pero no al resto / última responde de forma contemp. a todas
...
info.lhs_names  = {'yext','pibperc','ginitot2','tpm'};  % primera variable no responde de forma contemp. / segunda responde contemp. a la primera pero no al resto / última responde de forma contemp. a todas
...
info.lhs_names  = {'libor','pibperc','ginitot2','tpm'};  % primera variable no responde de forma contemp. / segunda responde contemp. a la primera pero no al resto / última responde de forma contemp. a todas
...
% Define right-hand side endogenous variables for each equation        
% Note: to impose zero restrictions use [] for the respective variable
info.rhs_names  = {'libor',[],[],[];...
                   'libor','pibperc','ginitot2','tpm';...
                   'libor','pibperc','ginitot2','tpm';...
                   'libor','pibperc','ginitot2','tpm';... 
                   };     
...
info.lhs_names  = {'libembi','pibperc','ginitot2','tpm'};  % primera variable no responde de forma contemp. / segunda responde contemp. a la primera pero no al resto / última responde de forma contemp. a todas
...
% Define right-hand side endogenous variables for each equation        
% Note: to impose zero restrictions use [] for the respective variable
info.rhs_names  = {'libembi',[],[],[];...
                   'libembi','pibperc','ginitot2','tpm';...
                   'libembi','pibperc','ginitot2','tpm';...
                   'libembi','pibperc','ginitot2','tpm';... 
                   };             
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
    case 1
        xlswrite('6_Robustez_SVAR_Bloque_Exogeno.xlsx',AA,'output','C5');
        xlswrite('6_Robustez_SVAR_Bloque_Exogeno.xlsx',BB,'output','C28');
    case 2
        xlswrite('6_Robustez_SVAR_Bloque_Exogeno.xlsx',AA,'output','W5');
        xlswrite('6_Robustez_SVAR_Bloque_Exogeno.xlsx',BB,'output','W28');
    case 3
        xlswrite('6_Robustez_SVAR_Bloque_Exogeno.xlsx',AA,'output','AQ5');
        xlswrite('6_Robustez_SVAR_Bloque_Exogeno.xlsx',BB,'output','AQ28');
    case 4
        xlswrite('6_Robustez_SVAR_Bloque_Exogeno.xlsx',AA,'output','BK5');
        xlswrite('6_Robustez_SVAR_Bloque_Exogeno.xlsx',BB,'output','BK28');       
    case 5
        xlswrite('6_Robustez_SVAR_Bloque_Exogeno.xlsx',AA,'output','CG5');
        xlswrite('6_Robustez_SVAR_Bloque_Exogeno.xlsx',BB,'output','CG28');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
end;