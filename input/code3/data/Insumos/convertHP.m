...
opts.Sheet = "filter";
opts.DataRange = "A2:O179";

% Definimos el nombre de las columnas y el formato de los datos
opts.VariableNames = ["date", "ln_pib", "ln_c", "ln_tdi", "tpm", "tpm2", "dfl", "inf", "dfl2", "inf2", "fedfund", "m1", "m3", "tcr", "rext"];
...
[rext_t,rext_c] = HP(rext,1600);

TEND = [ln_pib_t, ln_c_t, ln_tdi_t, tpm_t, tpm2_t, dfl_t, inf_t, dfl2_t, inf2_t, fedfund_t, m1_t, m3_t, tcr_t, rext_t];
CYCLE = [ln_pib_c, ln_c_c, ln_tdi_c, tpm_c, tpm2_c, dfl_c, inf_c, dfl2_c, inf2_c, fedfund_c, m1_c, m3_c, tcr_c, rext_c];

xlswrite('data.xlsx',TEND,'filter','Q2');
xlswrite('data.xlsx',CYCLE,'filter','AF2')
...
[m3_t,m3_c] = HP(m3,1600);
[tcr_t,tcr_c] = HP(tcr,1600);
[ln_g_t,ln_g_c] = HP(ln_g,1600);


TEND = [ln_pib_t, ln_c_t, ln_tdi_t, tpm_t, tpm2_t, dfl_t, inf_t, dfl2_t, inf2_t, fedfund_t, m1_t, m3_t, tcr_t, ln_g_t];
CYCLE = [ln_pib_c, ln_c_c, ln_tdi_c, tpm_c, tpm2_c, dfl_c, inf_c, dfl2_c, inf2_c, fedfund_c, m1_c, m3_c, tcr_c, ln_g_c];

xlswrite('data.xlsx',TEND,'filter2','P2');
xlswrite('data.xlsx',CYCLE,'filter2','AD2')
